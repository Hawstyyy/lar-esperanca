...
### Login
p_login = ctk.CTkFrame(root, fg_color= 'white', corner_radius= 0)
p_login.place(relheight=1,relwidth=1)
### Tela Principal
p_principal = ctk.CTkFrame(root,bg_color='white', corner_radius= 0)
p_principal.place(relheight=1,relwidth=1)
### Tabela Pacientes
p_pacientes = ctk.CTkFrame(root,bg_color='white', corner_radius= 0)
p_pacientes.place(relheight=1,relwidth=1)
### Nova Receita
p_receita = ctk.CTkFrame(root,bg_color='white', corner_radius= 0)
p_receita.place(relheight=1,relwidth=1)
### Sinal Vital
p_sinal_vital = ctk.CTkFrame(root,bg_color='white', corner_radius= 0)
p_sinal_vital.place(relheight=1,relwidth=1)
### Intercorrência
p_intercorrencia = ctk.CTkFrame(root,bg_color='white', corner_radius= 0)
p_intercorrencia.place(relheight=1,relwidth=1)
### Registro de Funcionário
p_registro = ctk.CTkFrame(root, fg_color= 'white', corner_radius= 0)
